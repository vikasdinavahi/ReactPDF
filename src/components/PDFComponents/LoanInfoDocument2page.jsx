...
export const LoanInfoDocument2Page=() =>{
    return (
                        ...
                        <View style={styles.tableColMain} >   
                            ...
                            <View style={styles.tableRow}  > 
                                ...
                                <View style={styles.tableRow}  > 
                                    ...
                                    <View style={styles.tableCol} >  
                                        <Text style={styles.tdValue}> Sam Adams </Text>
                                    </View>
                                </View>
                                <View style={styles.tableRow}  > 
                                    <View style={styles.tableCol} >  
                                ...
                                <View style={styles.tableRow}  > 
                                    ...
                                    <View style={styles.tableCol} >  
                                        <Text style={styles.tdValue}> 1676 CR 328 , Sanata Cr, TX, 78026 </Text>
                                    </View>
                                </View>
                                <View style={styles.tableRow}  > 
                                    <View style={styles.tableCol} >  
